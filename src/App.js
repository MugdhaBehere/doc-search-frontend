...
const App = () => {
  ...
  const handleSearch = async () => {
    try {
      ...
      const response = await axios.get(`https://document-search-backend.onrender.com/search/query?query=${query}`);
  ...
  const fetchSuggestions = _.debounce(async (prefix) => {
    ...
    try {
      ...
      const response = await axios.get(`https://document-search-backend.onrender.com/search/suggestions?prefix=${prefix}`);
  ...
  const indexDocument = async () => {
    try {
      ...
      const response = await axios.post(`https://document-search-backend.onrender.com/search/index`, null, {
